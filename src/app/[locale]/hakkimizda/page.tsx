        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-center">
             <div className="relative group">
                ...
                <div className="aspect-[4/5] bg-white rounded-[2.5rem] overflow-hidden shadow-2xl relative border-8 border-white">
                   {/* Placeholder for clinic/founders image */}
                   <div className="absolute inset-0 bg-primary-100 flex flex-col items-center justify-center text-primary-300 space-y-4">
                      <svg className="w-20 h-20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                      </svg>
                      <span className="text-sm font-medium tracking-widest uppercase">Koridor Psikoloji Klinik</span>
                   </div>
                </div>
             </div>
             <div>
